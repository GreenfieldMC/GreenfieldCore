...
public class ModuleConfig extends Configuration {
    ...
    private final boolean greenfieldApi;
    ...
    public ModuleConfig(Plugin plugin) {
        ...
        addEntry("modules.greenfieldApi", true);
        ...
        greenfieldApi = getBoolean("modules.greenfieldApi");
    ...
    public boolean isGreenfieldApiEnabled() {
